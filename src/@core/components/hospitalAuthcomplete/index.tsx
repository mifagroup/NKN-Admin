...
const HospitalAuthcomplete = ({
  ...
  const { data: hospitalsData, isLoading: isLoadingHospitals } = useFetch().useQuery('get', '/hospitals', {
    params: {
      query: {
        ...queryParams
      }
        ...
        renderInput={params => (
          <DebouncedInput
            ...
            InputProps={{
              ...
              endAdornment: (
                <React.Fragment>
                  {isLoadingHospitals ? <CircularProgress color='inherit' size={20} /> : null}
...
export default HospitalAuthcomplete
