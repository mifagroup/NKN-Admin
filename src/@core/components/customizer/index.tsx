...
const Customizer = ({ breakpoint = 'lg', dir = 'ltr', disableDirection = false }: CustomizerProps) => {
  ...
  const themeTranslate = dictionary?.theme_customizer
      ...
      >
        ...
        <div className={classnames('customizer-header flex items-center justify-between', styles.header)}>
          <div className='flex flex-col gap-2'>
            <h4 className={styles.customizerTitle}>{themeTranslate?.theme_customizer_title}</h4>
            <p className={styles.customizerSubtitle}>{themeTranslate?.theme_customizer_subtitle}</p>
          </div>
        ...
        >
          <div className={classnames('customizer-body flex flex-col', styles.customizerBody)}>
            <div className='theming-section flex flex-col gap-6'>
              ...
              <div className='flex flex-col gap-2'>
                <p className='font-medium'>{themeTranslate?.primary_color}</p>
              ...
              <div className='flex flex-col gap-2'>
                <p className='font-medium'>{themeTranslate?.mode}</p>
                <div className='flex items-center justify-between'>
                  ...
                  <div className='flex flex-col items-start gap-0.5'>
                    ...
                    <p className={styles.itemLabel} onClick={() => handleChange('mode', 'system')}>
                      {themeTranslate?.system}
                    </p>
                  </div>
                </div>
              </div>
              <div className='flex flex-col gap-2'>
                <p className='font-medium'>{themeTranslate?.skin}</p>
            ...
            <div className='layout-section flex flex-col gap-6'>
              ...
              <div className='flex flex-col gap-2'>
                <p className='font-medium'> {themeTranslate?.layouts}</p>
                <div className='flex items-center justify-between'>
                  <div className='flex flex-col items-start gap-0.5'>
                    <div
                  ...
                  <div className='flex flex-col items-start gap-0.5'>
                    ...
                    <p className={styles.itemLabel} onClick={() => handleChange('layout', 'horizontal')}>
                      {themeTranslate?.horizontal}
                    </p>
                  </div>
                </div>
              </div>
              <div className='flex flex-col gap-2'>
                <p className='font-medium'> {themeTranslate?.content}</p>
                <div className='flex items-center gap-4'>
                  <div className='flex flex-col items-start gap-0.5'>
                    <div
              ...
              {!disableDirection && (
                <div className='flex flex-col gap-2'>
                  <p className='font-medium'> {themeTranslate?.direction}</p>
                  <div className='flex items-center gap-4'>
                    <Link href={getLocalePath(pathName, 'en')}>
                      <div className='flex flex-col items-start gap-0.5'>
                        ...
                        <p className={styles.itemLabel}>{themeTranslate?.ltr}</p>
                      </div>
                    </Link>
                    <Link href={getLocalePath(pathName, 'ar')}>
                      <div className='flex flex-col items-start gap-0.5'>
                        ...
                        <p className={styles.itemLabel}>{themeTranslate?.rtl}</p>
                      </div>
                    </Link>
                  </div>
                </div>
